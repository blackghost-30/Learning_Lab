...
- **数字图像**
  ...
  ![第一张数字图像](images/1.第一章/第一张数字图像.png)
...
- **灰度的概念**
  ...
  ![灰度图](images/1.第一章/灰度图.png)

  - 人的眼睛对灰度更敏感，一般在**16位到32位**之间，下方的两条线实质上是灰度一样的：

  ![人眼的灰度](images/1.第一章/人眼的灰度.png)
...
![OpenCV的logo](images/1.第一章/OpenCV的logo.png)
...
![OpenCV模块](images/1.第一章/OpenCV的模块.png)
...
![2-2最终效果](images/2.第二章/2-1-2_save.png)
...
![2-2对比图](images/2.第二章/2-2对比图.png)
...
![最终效果](images/2.第二章/2-2-2_save.png)
...
- **参数：**
  ...
  ![图像的平移之矩阵参数](images/3.第三章/3-1几何变换/图像的平移之矩阵参数.png)
...
![坐标轴的旋转](images/3.第三章/3-1几何变换/图像的旋转坐标示意图.png)

假设图像逆时针旋转了θ角，则根据坐标转换可得：

![旋转变换1](images/3.第三章/3-1几何变换/旋转方程式1.png)

其中有：

![几何角度关系](images/3.第三章/3-1几何变换/几何关系.png)

将其带入上面的公式中可得：

![旋转变换2](images/3.第三章/3-1几何变换/旋转方程式2.png)

用旋转矩阵来表示为：

![旋转矩阵1](images/3.第三章/3-1几何变换/旋转矩阵1.png)
...
![旋转示意图](images/3.第三章/3-1几何变换/旋转示意图.png)

即在原有的矩阵变换的基础上还需要再次进行一次矩阵变换：

![旋转矩阵2](images/3.第三章/3-1几何变换/旋转矩阵2.png)
...
![图像的旋转效果图](images/3.第三章/3-1几何变换/图像的旋转效果图.png)
...
![仿射变换示意图](images/3.第三章/3-1几何变换/仿射变换示意图.png)

- **OpenCV中的原理做法**

  - 在OpenCV中，仿射变换的矩阵是一个**2×3的矩阵**：

  ![仿射变换矩阵1](images/3.第三章/3-1几何变换/仿射变换矩阵1.png)

  - 其中左边的2×2子矩阵A是线性变换矩阵，右边的2×1子矩阵B是平移项：

  ![仿射变换矩阵2](images/3.第三章/3-1几何变换/仿射变换矩阵2.png)

  - 对于图像上的任一位置(x,y)，仿射变换执行的是如下的操作：

  ![仿射变换矩阵3](images/3.第三章/3-1几何变换/仿射变换矩阵3.png)
...
![图像的仿射变换效果图](images/3.第三章/3-1几何变换/图像的仿真变换效果图.png)
...
- **定义：**
  ...
  ![透射示意图](images/3.第三章/3-1几何变换/投影示意图.png)

- **OpenCv中的原理作用：**

  - 它的本质将图像投影到一个新的视平面，其通用变换公式为：

  ![透射变换矩阵1](images/3.第三章/3-1几何变换/透射变换矩阵1.png)

  - 其中，(u,v)是原始的图像像素坐标，w取值为1；
  - (x=x'/z',y=y'/z')是透射变换后的结果；
  - 后面的矩阵称为透视变换矩阵，一般情况下，我们将其分为三部分：

  ![透射矩阵2](images/3.第三章/3-1几何变换/透射变换矩阵2.png)
...
![图像的透射变换效果](images/3.第三章/3-1几何变换/透射变换效果图.png)
...
![图像金字塔](images/3.第三章/3-1几何变换/图像金字塔.jpeg)
...
![图像金字塔效果图](images/3.第三章/3-1几何变换/图像金字塔效果图.png)
...
![邻接的概念](images/3.第三章/3-2形态学操作/邻接的概念.png)
...
- 根据连通性的定义，有4联通、8联通和m联通三种：
  ...
  ![4连通与8连通](images/3.第三章/3-2形态学操作/4连通和8连通.png)
  ...
  - **m连通**：对于具有值*V*的像素*p*和*q*，如果：
    ...
    ![m连通示意图](images/3.第三章/3-2形态学操作/m连通.png)
...
- **膨胀**
  ...
  ![膨胀操作](images/3.第三章/3-2形态学操作/膨胀操作.png)
...
- **腐蚀**
  ...
  ![腐蚀操作](images/3.第三章/3-2形态学操作/腐蚀操作.png)
...
![服饰与膨胀效果图](images/3.第三章/3-2形态学操作/腐蚀与膨胀效果图.png)
...
![开运算示意图](images/3.第三章/3-2形态学操作/开运算示意图.png)
...
![闭运算示意图](images/3.第三章/3-2形态学操作/闭运算示意图.png)
...
![开闭运算示意图](images/3.第三章/3-2形态学操作/开闭运算示意图.png)
...
![礼帽公式运算](images/3.第三章/3-2形态学操作/礼帽计算公式.png)
...
![黑帽计算公式](images/3.第三章/3-2形态学操作/黑帽计算公式.png)
...
- **参数：**
  ...
  ![黑帽礼帽参数选择](images/3.第三章/3-2形态学操作/黑帽礼帽参数选择.png)
...
![黑帽礼帽运算效果图](images/3.第三章/3-2形态学操作/黑帽礼帽运算结果图.png)
...
![椒盐噪声](images/3.第三章/3-3图像平滑/椒盐噪声.png)
...
![高斯噪声公式](images/3.第三章/3-3图像平滑/高斯噪声公式.png)

- 高斯函数的曲线如图所示：

![高斯噪声概率密度分布](images/3.第三章/3-3图像平滑/高斯噪声的概率密度.png)

- 带有高斯噪声的图片如图所示：

![高斯噪声图片](images/3.第三章/3-3图像平滑/高斯噪声.png)
...
![均值滤波的介绍](images/3.第三章/3-3图像平滑/均值滤波的介绍.png)
...
![均值滤波效果图](images/3.第三章/3-3图像平滑/均值滤波效果图.png)
...
![二维高斯的概率密度分布](images/3.第三章/3-3图像平滑/二维高斯概率密度函数.png)

- 二维高斯在可视化上是一个突起的帽子的形状，其中σ可看成两个值，分别为x、y方向标准差：
  - 两个σ的取值越大，整个形状越平坦；两个σ的取值越小，整个形状越突起；

![二维高斯的图形化](images/3.第三章/3-3图像平滑/二维高斯的图形化.png)
...
- **高斯滤波的流程**
  ...
  ![权重矩阵的形状](images/3.第三章/3-3图像平滑/最近点分布.png)

  - 确定权重矩阵的取值：指定两个σ的值，权重矩阵随之确定，这里取1.5

  ![未归一化权重矩阵](images/3.第三章/3-3图像平滑/指定σ后的权重矩阵.png)

  - 归一化权重矩阵：由于指定σ后的权重矩阵不是归一化的，需要将其归一化

  ![归一化权重矩阵](images/3.第三章/3-3图像平滑/归一化权重矩阵.png)

  - 获得原图像像素的取值：

  ![原图像像素值](images/3.第三章/3-3图像平滑/原图像的像素值.png)

  - 进行高斯滤波：接着就可以进行高斯模糊了

  ![高斯模糊](images/3.第三章/3-3图像平滑/高斯滤波过程.png)

  - 得到高斯结果：

  ![高斯模糊结果](images/3.第三章/3-3图像平滑/高斯滤波结果.png)
...
![高斯滤波效果图](images/3.第三章/3-3图像平滑/高斯滤波效果图.png)
...
![中值滤波示意图](images/3.第三章/3-3图像平滑/中值滤波效果图.png)
...
![直方图的表示](images/3.第三章/3-4直方图/直方图的表示.png)
...
![运行效果](images/3.第三章/3-4直方图/直方图效果.png)
...
![掩膜效果图](images/3.第三章/3-4直方图/掩膜效果图.png)
...
![直方图均衡化](images/3.第三章/3-4直方图/图像直方图均衡化.png)
...
![直方图均衡化效果](images/3.第三章/3-4直方图/直方图均衡化的结果.png)
...
- **自适应均衡化：解决均衡化的缺点**
  ...
  ![自适应均衡化](images/3.第三章/3-4直方图/自适应均衡化.png)
...
![自适应均衡化效果](images/3.第三章/3-4直方图/自适应均衡化效果图.png)
...
![边缘的表现形式](images/3.第三章/3-5边缘检测/边缘的表现形式.png)
...
![基于搜索的边缘检测](images/3.第三章/3-5边缘检测/搜索的边缘检测.png)

- **基于零穿越的边缘检测：**
  - 通过寻找**图像二阶导数零穿越**来寻找边界；
  - 代表算法是**Laplacian算子**；

![基于零穿越的边缘检测](images/3.第三章/3-5边缘检测/零穿越的边缘检测.png)
...
![不连续函数的一阶导数](images/3.第三章/3-5边缘检测/不连续函数的一阶导数.png)

- **实际中sobel算子的卷积核运算：高斯权重加一阶微分**

![sobel算子的操作](images/3.第三章/3-5边缘检测/sobel算子.png)
...
![scharr算子](images/3.第三章/3-5边缘检测/scharr算子.png)
...
![sobel结果图](images/3.第三章/3-5边缘检测/sobel结果图.png)
...
![scharr结果图](images/3.第三章/3-5边缘检测/scharr结果图.png)
...
![拉普拉斯算子介绍](images/3.第三章/3-5边缘检测/拉普拉斯算子介绍.png)
...
![拉普拉斯算子效果图](images/3.第三章/3-5边缘检测/拉普拉斯算子的效果图.png)
...
- **第二步：计算图像梯度**
  ...
  ![公式](images/3.第三章/3-5边缘检测/Canny算法检测边缘公式.png)
...
- **第三步：非极大值抑制**
  ...
  ![非极大值抑制](images/3.第三章/3-5边缘检测/非极大值抑制.png)
...
- **第四步：滞后阈值**
  ...
  ![滞后阈值](images/3.第三章/3-5边缘检测/滞后阈值.png)
...
![Canny算法效果图](images/3.第三章/3-5边缘检测/Canny算法效果图.png)
...
![算子比较](images/3.第三章/3-5边缘检测/算子比较.png)
...
- **实现流程：**
  ...
  ![模板匹配的输入](images/3.第三章/3-6模板匹配/模板匹配的输入图像.jpg)

  - **滑动模板图像和原图像进行比对：**

    - 模板每次移动一个像素 (从左往右，从上往下)，在每一个位置，都计算与模板图像的相似程度：

    ![模板匹配的相似度计算](images/3.第三章/3-6模板匹配/模板匹配的相似度计算.jpg)
  ...
  - **模板比对的结果：**
    ...
    ![模板匹配比对结果](images/3.第三章/3-6模板匹配/模板比对结果.jpg)
...
![模板匹配效果图](images/3.第三章/3-6模板匹配/模板匹配效果图.png)
...
![霍夫变换简介](images/3.第三章/3-6模板匹配/霍夫变换简介 .png)
...
![笛卡尔坐标系的直线表示](images/3.第三章/3-6模板匹配/笛卡尔坐标系的直线表示.png)
...
![笛卡尔坐标系与霍夫坐标系的变换](images/3.第三章/3-6模板匹配/笛卡尔坐标系与霍夫坐标系的变换.png)

- **规律总结：**
  - **笛卡尔坐标系中的一条直线，对应于霍夫空间中的一个点；**
  - **霍夫空间中的一条直线，对应笛卡尔坐标系中的一个点**：

![霍夫空间到笛卡尔坐标系的变换](images/3.第三章/3-6模板匹配/霍夫空间到笛卡尔坐标系的变换.png)

#### 2.3 笛卡尔坐标系的点共线与霍夫空间的线相交

- 笛卡尔坐标系中的三点共线，与霍夫空间的**三线相交**：

![三点共线与三线相交](images/3.第三章/3-6模板匹配/三点共线与三线共点.png)
...
![存在不共线的情况](images/3.第三章/3-6模板匹配/多点相交的情况.png)

#### 2.4 极坐标下的霍夫变换

- 霍夫空间的某个点，本质对应了笛卡尔坐标系中**某条直线的斜率和截距**，可能会出现**斜率和截距为∞**的情况：

![极限情况](images/3.第三章/3-6模板匹配/极限情况.png)

- 可采用**极坐标的方式**解决这个问题：

![极坐标解决](images/3.第三章/3-6模板匹配/极坐标变换.png)

- 以**r和ρ为空间**，其中ρ是原点到直线的垂直距离，θ表示直线的垂线与横轴顺时针方向的夹角：
  - 原坐标系中的一个点在极坐标系下的霍夫空间是一条正弦曲线；
  - 当原坐标系中多个点共线，在极坐标下的霍夫空间则多条线共点；

![极坐标下的空间转换](images/3.第三章/3-6模板匹配/极坐标下的空间转换.png)
...
![2D数组](images/3.第三章/3-6模板匹配/2D数组.png)
...
- **在累加器中画线：**
  ...
  ![实现流程](images/3.第三章/3-6模板匹配/实现流程.gif)
...
![霍夫线检测示意图](images/3.第三章/3-6模板匹配/霍夫线检测示意图.png)
...
![霍夫线效果](images/3.第三章/3-6模板匹配/霍夫线检测效果.png)
...
![霍夫圆检测效果](images/3.第三章/3-6模板匹配/霍夫圆检测效果.png)
...
![Harris算法原理](images/4.第四章/4-2Harris和shi-tomas算法/Harris算法.png)
...
![Harris权重](images/4.第四章/4-2Harris和shi-tomas算法/Harris权重.png)
...
![Harris算子推导](images/4.第四章/4-2Harris和shi-tomas算法/Harris算子推导.png)

- **图形化结果：**
  - $M$是$I_x$和$I_y$的二次项函数，可以表示成椭圆的形状，椭圆的长短半轴由$M$的特征值$λ_1$和$λ_2$决定，方向由特征矢量决定，如下图所示：

![M矩阵的椭圆表示](images/4.第四章/4-2Harris和shi-tomas算法/M矩阵的椭圆表示.png)
...
![椭圆特征值与角点判断](images/4.第四章/4-2Harris和shi-tomas算法/椭圆特征值与角点判断.png)
...
- **角点的判断：**根据前面的角点响应值可以判断角点
  ...
  <img src="images/4.第四章/4-2Harris和shi-tomas算法/Harris中的角点判断.png" alt="焦点判断" style="zoom:50%;" />
...
<img src="images/4.第四章/4-2Harris和shi-tomas算法/Harris检测结果.png" alt="Harris检测结果" style="zoom:50%;" />
...
![shi-tomas的结果示意图](images/4.第四章/4-2Harris和shi-tomas算法/shi-tomas算法的结果.png)
...
<img src="images/4.第四章/4-2Harris和shi-tomas算法/shi-tomas算法效果.png" alt="shi-tomas算法效果" style="zoom:50%;" />
...
![Harris算法缺点](images/4.第四章/4-3SIFT与SURF算法/Harris算法的缺点.png)
...
![图像的高斯金字塔](images/4.第四章/4-3SIFT与SURF算法/图像高斯金字塔.png)
...
![高斯差分金字塔](images/4.第四章/4-3SIFT与SURF算法/高斯差分金字塔.png)
...
- **极值点搜索的原理：**
  ...
  ![局部最大值搜索](images/4.第四章/4-3SIFT与SURF算法/局部最大值搜索.png)
...
- **梯度特征的采集：**
  ...
  ![梯度数据采集](images/4.第四章/4-3SIFT与SURF算法/梯度数据采集结果.png)
...
- **梯度特征的统计：**
  ...
  - **具体做法是：**
    ...
    ![梯度特征统计](images/4.第四章/4-3SIFT与SURF算法/梯度特征统计.png)
...
- **梯度特征的插值拟合：**
  ...
  ![梯度特征的插值拟合](images/4.第四章/4-3SIFT与SURF算法/梯度特征的插值拟合.png)
...
- **关键点方向的确定：**
  ...
  - 通常使用一个带箭头的圆或直接使用箭头表示SIFT区域的三个值：
    ...
    ![关键点方向的确定](images/4.第四章/4-3SIFT与SURF算法/确定后的关键点效果.png)
...
- **子区域的划分：**
  ...
  ![子区域的划分](images/4.第四章/4-3SIFT与SURF算法/子区域的划分.png)

- **旋转不变性的保持：**

  - 为了保证特征点的旋转不变性，以特征点为中心，将坐标轴旋转为关键点的主方向，如下图所示：

  ![旋转不变性的保持](images/4.第四章/4-3SIFT与SURF算法/旋转不变性的保持.png)
...
- **插值法确定像素梯度：**
  ...
  ![插值法](images/4.第四章/4-3SIFT与SURF算法/插值法.png)
...
![SURF与SIFT的对比](images/4.第四章/4-3SIFT与SURF算法/SIFT和SURF的对比.png)
...
![像素示意](images/4.第四章/4-4FAST与ORB算法/FAST算法基本示意.jpg)
...
![特征向量](images/4.第四章/4-4FAST与ORB算法/特征向量.png)

- 每一个特征点的 16 像素点都属于下列三类中的一种

![像素点的分类](images/4.第四章/4-4FAST与ORB算法/像素点的分类.jpg)
...
![FAST算法效果](images/4.第四章/4-4FAST与ORB算法/FAST算法效果.png)
...
- **具体流程描述如下：**
  ...
  ![图像金字塔](images/4.第四章/4-4FAST与ORB算法/图像金字塔.png)
...
- **选取点对**
  ...
  ![点对的选取方法](images/4.第四章/4-4FAST与ORB算法/点对的选取方法.png)
...
- **构建描述符**
  ...
  ![描述符](images/4.第四章/4-4FAST与ORB算法/描述符.png)
...
![ORB算法效果](images/4.第四章/4-4FAST与ORB算法/ORB算法的效果图.png)
...
- **视频的属性信息**
  ...
  - **参数：**
    ...
    ![常用属性](images/5.第五章/5-1视频文件的读取和保存/获取视频的属性.png)
...
- **meanshift算法的作用**
  ...
  ![meanshift的通俗理解](images/5.第五章/5-2视频追踪/点密度示意图.jpg)
...
- **meanshift算法在视频跟踪中的实际优化：**
  ...
  ![meanshift算法的跟踪过程](images/5.第五章/5-2视频追踪/meanshift算法的跟踪过程.gif)
...
- **camshift算法的演示：**
  ...
  ![camshift算法的演示](images/5.第五章/5-2视频追踪/camshift算法演示图.gif)
...
- **Haar特征的介绍：**
  ...
  <img src="images/6.第六章/haar特征.png" alt="Haar特征" style="zoom:50%;" />
...
- **Haar特征的物理意义：**
  ...
  <img src="images/6.第六章/Haar检测示意.png" alt="Haar检测示意" style="zoom:50%;" />
...
<img src="images/6.第六章/决策器.png" alt="决策树" style="zoom:50%;" />
...
![OpenCv中的分类器](images/6.第六章/OpenCV中的分类器.png)
